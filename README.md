...
partir de compromissos reais → metas com cenários conservador/
realista/agressivo comparadas ao resultado real → integração real de
e-mail (SMTP)/WhatsApp Business com verificação de conexão ao vivo e
