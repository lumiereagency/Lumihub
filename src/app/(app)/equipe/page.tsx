...
export default async function TeamPage() {
  ...
  return (
    <div>
      <PageHeader title="Equipe" description="Funcionários, freelancers e prestadores, com custo por projeto." />
      <TeamList
        ...
        emptyLabel="Nenhum membro da equipe cadastrado ainda"
        createLabel="Novo membro da equipe"
      />
    </div>
  );
}
