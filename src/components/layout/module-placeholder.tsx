...
// roadmap do LUMIBASE — nunca dados fictícios, apenas "em construção" honesto.
  ...
  return (
    <div>
      ...
      <EmptyState
        ...
        description="Este módulo está planejado no roadmap do LUMIBASE e será implementado em uma próxima fase de desenvolvimento."
      />
    </div>
  );
}
